			...
			<ul class="nav ace-nav">
						...
						<li class="dropdown-content">
							<ul class="dropdown-menu dropdown-navbar">
								<li><a href="#" class="clearfix"> <img
										src="/templates/admin/assets/avatars/avatar.png" class="msg-photo"
								...
								<li><a href="#" class="clearfix"> <img
										src="/templates/admin/assets/avatars/avatar3.png" class="msg-photo"
								...
								<li><a href="#" class="clearfix"> <img
										src="/templates/admin/assets/avatars/avatar4.png" class="msg-photo"
								...
								<li><a href="#" class="clearfix"> <img
										src="/templates/admin/assets/avatars/avatar2.png" class="msg-photo"
								...
								<li><a href="#" class="clearfix"> <img
										src="/templates/admin/assets/avatars/avatar5.png" class="msg-photo"
				...
				<li class="light-blue"><a data-toggle="dropdown" href="#"
					class="dropdown-toggle"> <img class="nav-user-photo"
						src="<c:url value='/templates/admin/assets/avatars/user.jpg' />" alt="Jason's Photo" /> <span
