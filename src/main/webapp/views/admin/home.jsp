												...
												<div class="itemdiv dialogdiv">
													<div class="user">
														<img alt="Alexa's Avatar"
															src="/templates/admin/assets/avatars/avatar1.png" />
													</div>
												...
												<div class="itemdiv dialogdiv">
													<div class="user">
														<img alt="John's Avatar"
															src="/templates/admin/assets/avatars/avatar.png" />
													</div>
												...
												<div class="itemdiv dialogdiv">
													<div class="user">
														<img alt="Bob's Avatar"
															src="/templates/admin/assets/avatars/user.jpg" />
													</div>
												...
												<div class="itemdiv dialogdiv">
													<div class="user">
														<img alt="Jim's Avatar"
															src="/templates/admin/assets/avatars/avatar4.png" />
													</div>
